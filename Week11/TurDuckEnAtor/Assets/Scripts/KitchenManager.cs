    ...
    void Update()
    {
        ...
        switch(chefState)
        {
            ...
            case CurrentOperation.GetDuck:
                currentDuck = duckPond.RemoveDuck();    // I think I removed a line here
            ...
            case CurrentOperation.BoneTurkey:
                currentTurkey.Debone();                 // I think I removed a line here
        ...
        if (!duckPond.NoMoreDucks())
        {
            ...
            {
                pondText.text += weight.ToString() + " ";                       // I think I removed a line here
            }
        }
        else
        {
        ...
        {
            foreach (int weight in chickenCoop.GetRemainingChickenWeights())    // I think I removed a line here
            {
